  ...
  tokenizer: {
    root: [
      ...
      [/^(\s*)(-)(\s*)(\[)([ xX])(\])(\s*)/, [
        ...
        'delimiter.bracket',
        { cases: {
          '[ ]': 'keyword.todo.unchecked',
          '[x]': 'keyword.todo.checked',
          '[X]': 'keyword.todo.checked'
        }},
        'delimiter.bracket',
        'white'
      ...
      // 标题（# ## ### 等）
      [/^(#{1,6})(\s+)(.*)$/, ['keyword.header', 'white', 'string.header']],
      ...
      // 用时标记 T:2h, T:1d 等
      [/T:(\d+(?:\.\d+)?)(h|d|w|m|y|小时|天|周|月|年|min|分钟)/, ['keyword.duration', 'keyword.time.unit']],

      // 依赖关系 -> task1, task2
      [/->/, 'keyword.dependency.arrow'],
      [/(?<=->)(\s*)([^,\n]+)/, ['white', 'string.dependency']],
      ...
      // 链接
      [/\[([^\]]*)\]\(([^)]*)\)/, ['string.link.text', 'string.link.url']],
      [/https?:\/\/[^\s]+/, 'string.url'],
...
export const todoTheme = {
  ...
  rules: [
    ...
    { token: 'keyword.todo.unchecked', foreground: 'ff6b6b', fontStyle: 'bold' },
    { token: 'keyword.todo.checked', foreground: '51cf66', fontStyle: 'bold' },
    ...
    { token: 'keyword.time.unit', foreground: 'ae3ec9' },
    { token: 'keyword.dependency.arrow', foreground: 'f76707', fontStyle: 'bold' },
    { token: 'string.dependency', foreground: 'f76707' },
    ...
    { token: 'string.link.text', foreground: '0969da' },
    { token: 'string.link.url', foreground: '0969da', fontStyle: 'underline' },
...
export const todoDarkTheme = {
  ...
  rules: [
    ...
    { token: 'keyword.todo.unchecked', foreground: 'ff7b72', fontStyle: 'bold' },
    { token: 'keyword.todo.checked', foreground: '7ee787', fontStyle: 'bold' },
    ...
    { token: 'keyword.time.unit', foreground: 'd2a8ff' },
    { token: 'keyword.dependency.arrow', foreground: 'ffa657', fontStyle: 'bold' },
    { token: 'string.dependency', foreground: 'ffa657' },
    ...
    { token: 'string.link.text', foreground: '58a6ff' },
    { token: 'string.link.url', foreground: '58a6ff', fontStyle: 'underline' },
